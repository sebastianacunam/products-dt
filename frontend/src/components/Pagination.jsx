    ...
    <div className="flex flex-col sm:flex-row justify-center items-center border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
      <div className="flex justify-center items-center mb-2 sm:mb-0 sm:mr-4">
        <p className="text-sm text-gray-700 mr-2">
          Mostrando <span className="font-medium">{currentPage}</span> a <span className="font-medium">{totalPages}</span> de <span className="font-medium">{products}</span> de <span className="font-medium">{totalProductos}</span> resultados
        </p>
      </div>
